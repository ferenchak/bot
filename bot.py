...
ROLES = {
    "direct": {
        ...
        "questions": [
            ...
            "Скільки з них ініційовані нами?",
            "Скільки з них ініційовані клієнтами?",
        ...
        "headers": [
            "Дата", "Час", "Ім'я",
            "Чатів розпочато", "Ініційовані нами", "Ініційовані клієнтами",
            "Продажі", "Сума продаж",
    ...
    "storiesmaker": {
        ...
        "questions": [
            ...
            "Скільки рілсів опубліковано?",
            "Загальне охоплення сторіз?",
            "Скільки реакцій/відповідей отримали?",
            "Скільки переходів у Direct зі сторіз?",
            "Твої вчорашні плани. Що було з цього зроблено?",
            "Плани на завтрашній день?",
        ],
        "headers": [
            "Дата", "Час", "Ім'я",
            "Сторіз", "Рілсів", "Охоплення", "Реакцій", "Переходів у Direct",
            "Вчорашні плани (виконано)", "Плани на завтра",
        ],
    },
    "deputy": {
        "name": "Заступник керівника",
        "questions": [
            ...
            "Що було зроблено для розвитку напрямку?",
            "Твої вчорашні плани. Що було з цього зроблено?",
            "Плани на завтрашній день?",
        ],
        "headers": [
    ...
    "boss": {
        ...
        "headers": [
            "Дата", "Час", "Ім'я",
            "Оборот", "Прибуток", "Ключові рішення",
            "Вчорашні плани (виконано)", "Плани на завтра",
        ],
    },
}
